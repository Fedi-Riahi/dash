        ...
        <div className="flex items-center justify-between mx-8">
          ...
          <div>
            ...
            <input
              ...
              className="px-8 py-2 rounded border border-gray-300 mb-4 w-72 mx-8"
            />
            <Link
              ...
              <>
                ...
                {filteredCarParts.map((carPart) => (
                  ...
                  >
                    {/* Car part image */}
                    <img
                      src={carPart.images[0]} // Assuming there's an imageURL property in carPart
...
export default withAuth(CarPartsListing);
